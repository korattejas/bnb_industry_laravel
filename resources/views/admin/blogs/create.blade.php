                                    ...
                                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form"
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="slug"
                                                        placeholder="Slug Title" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    <label>Excerpt</label>
                                                    <textarea class="form-control" name="excerpt" rows="3" placeholder="Short excerpt"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mt-2">
                                             ...
                                             <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="meta_keywords" rows="6" placeholder="Meta Keywords"></textarea>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="meta_description" rows="6" placeholder="Meta Description"></textarea>
                                                </div>
                                            </div>
