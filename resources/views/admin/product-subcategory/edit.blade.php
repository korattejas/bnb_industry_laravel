            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Product Sub Category</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.dashboard') }}">{{ trans('admin_string.home') }}</a></li>
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.product-subcategory.index') }}">Product Sub Category</a>
                                    </li>
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    @if(!empty($subcategory->icon))
                                                        <div class="mb-3">
                                                            <img src="{{ asset('uploads/product-subcategory/' . $subcategory->icon) }}"
