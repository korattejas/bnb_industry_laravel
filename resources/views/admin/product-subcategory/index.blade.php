            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Product Subcategory</h2>
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <a href="{{ route('admin.product-subcategory.create') }}" class="btn btn-primary">
...
@section('footer_script_content')
    <script>
        ...
        const form_url = '/product-subcategory';
        datatable_url = '/getDataProductSubcategory';
