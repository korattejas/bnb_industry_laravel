        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Client</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" data-parsley-validate="" id="addEditForm" role="form">
                                    @csrf
                                    <input type="hidden" name="edit_value" value="{{ $client->id }}">
                                        ...
                                        <div class="col-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                @if($client->icon && file_exists(public_path('uploads/clients/' . $client->icon)))
                                                    <div class="mb-2">
                                                        <img src="{{ asset('uploads/clients/' . $client->icon) }}" style="max-width: 200px; border-radius: 8px;" alt="Client Icon">
                                                    </div>
                                                @endif
