            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Product Brand</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Edit Product Brand</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="description" rows="4" placeholder="{{ trans('admin_string.description') }}">{{ $category->description ?? '' }}</textarea>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        @if (isset($category->icon) && !empty($category->icon))
                                                            <div class="mb-3">
                                                                <img src="{{ asset('uploads/product-brand/' . $category->icon) }}"
                                                                    alt="Category Image"
