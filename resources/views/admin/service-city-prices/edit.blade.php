            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Service City Price</h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form"
                                        ...
                                        @csrf
                                        <input type="hidden" name="edit_value" value="{{ $serviceCityPrice->id }}">
                                                    ...
                                                    <select name="city_id" id="city_id" class="form-control select2">
                                                        ...
                                                        @foreach ($cities as $city)
                                                            <option value="{{ $city->id }}"
                                                                {{ $serviceCityPrice->city_id == $city->id ? 'selected' : '' }}>
                                                                {{ $city->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-6 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" id="price" class="form-control"
                                                        value="{{ $serviceCityPrice->price }}" placeholder="Enter Price"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status" class="form-control">
                                                        <option value="1"
                                                            {{ $serviceCityPrice->status == 1 ? 'selected' : '' }}>Active
                                                        </option>
                                                        <option value="0"
                                                            {{ $serviceCityPrice->status == 0 ? 'selected' : '' }}>Inactive
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
...
@section('footer_script_content')
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, service) {
                            ...
                            $serviceSelect.append('<option value="' + service.id + '" ' + selected +
                                '>' + service.name + '</option>');
                        });
                    }
                });
        ...
        $(document).ready(function() {
            ...
            var selectedServiceId = "{{ $serviceCityPrice->service_id }}";
            if (categoryId) {
