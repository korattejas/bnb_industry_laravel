        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Add Blog Category</h2>
...
<script>
    var form_url = 'blog-category/store';
    var redirect_url = 'blog-category';
