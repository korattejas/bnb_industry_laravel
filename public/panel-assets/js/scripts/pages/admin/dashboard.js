$(function () {
    ...
    // Donut Chart
    // --------------------------------------------------------------------
    var donutChartEl = document.querySelector('#user-donut-chart'),
        donutChartConfig = {
            chart: {
                height: 350,
                type: 'donut'
            ...
            labels: ['Total Users', 'Active Seller ', 'Active Agent ', 'Active Owner'],
            series: [85, 16, 50, 50],
            colors: [
    ...
    var donutChartEll = document.querySelector('#horses-donut-chart'),
        donutChartConfig = {
            chart: {
                height: 350,
                type: 'donut'
            ...
            labels: ['Total Horses', 'Active Horses ', 'Inactive Horses'],
            series: [85, 16, 50],
            colors: [
                chartColors.donut.series1,
                chartColors.donut.series5,
    ...
    if (typeof donutChartEll !== undefined && donutChartEll !== null) {
        var donutChartt = new ApexCharts(donutChartEll, donutChartConfig);
        donutChartt.render();
    }
